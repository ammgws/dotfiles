...
abbr --add sclu 'systemctl --user'
abbr --add upall 'paru --sync --refresh --sysupgrade --devel --needed --noconfirm; and fish_update_completions; and fisher'
abbr --add uparch 'sudo pacman --sync --refresh --sysupgrade; and fish_update_completions'
abbr --add upaur 'paru --sync --refresh --sysupgrade --devel --needed --noconfirm; and fish_update_completions'
